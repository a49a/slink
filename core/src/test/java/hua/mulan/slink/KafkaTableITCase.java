 ...
 * @create: 2020/08/28
 **/
public class KafkaTableITCase extends KafkaTestBase {

    protected static final Logger LOG = LoggerFactory.getLogger(KafkaTableITCase.class);

    @Test
    public void testStreamSqlKafkaSource() {
        final String topic = "IT_topic";
